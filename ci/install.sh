...
print_info "  - Headers: $INSTALL_PREFIX/include/cfl/"
print_info "  - CMake config: $INSTALL_PREFIX/lib/cmake/cfl/"
echo ""
...
echo "  find_package(cfl REQUIRED)"
echo "  target_link_libraries(your_target PRIVATE cfl::cfl)"
echo ""
