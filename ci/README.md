...
- Test executable: `build/test/test_cfl`
...
**Output:**
- Optimized library: `build/cfl_project.a`
...
- **User install** (`~/.local`):
  - Libraries: `~/.local/lib/`
  - Headers: `~/.local/include/cfl/`
  - CMake config: `~/.local/lib/cmake/cfl/`

- **Custom prefix** (`/opt/mylibs`):
  - Libraries: `/opt/mylibs/lib/`
  - Headers: `/opt/mylibs/include/cfl/`
  - CMake config: `/opt/mylibs/lib/cmake/cfl/`
...
- Check test assertions in `test/test_cfl.c`
