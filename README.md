...
```
cfl/
├── include/cfl/            # Public headers
│   ├── cfl.h               # Main API header
│   └── cfl_types.h         # Common types and definitions
├── src/                            # Implementation
│   ├── cfl.c               # Core implementation
│   └── cfl_int.c           # Internal utilities
├── test/                           # Unit tests (Unity framework)
│   ├── CMakeLists.txt              # Test build configuration
│   ├── test_cfl.c          # Example test file
│   └── README.md                   # Testing guide
├── cmake/                          # CMake modules
│   └── cflConfig.cmake.in  # Package config template
...
clang-format -i include/cfl/myheader.h
```
...
See [test/README.md](file:///home/dogukanarat/workspace/cfl/test/README.md) for a comprehensive guide on writing tests with Unity.
...
- Header files to `/usr/local/include/cfl/`
- CMake config files to `/usr/local/lib/cmake/cfl/`
...
GitHub: [dogukanarat/cfl](https://github.com/dogukanarat/cfl)
